...
train_and_evaluate_rf_model <- function(stock_data) {
  ...
  #predictions <- forecast(arima_model, h = nrow(gbm_test))
  ...
  #mae <- mae(predictions$mean, gbm_test$price)
  #mape <- mape(predictions$mean, gbm_test$price)
  #rmse <- rmse(predictions$mean, gbm_test$price)
  #wmape <- calculate_wmape(gbm_test$price, predictions$mean)
